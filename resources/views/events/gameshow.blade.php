...
<div class="p-8 bg-gray-100 min-h-screen">
    <h1 class="text-3xl font-bold mb-8 text-center text-blue-700">🎮 Daftar Gameshow</h1>


<input type="text" id="searchInput" placeholder="Cari event..." class="w-full md:w-1/3 mb-6 p-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
